            ...
            <div className="flex h-full flex-1 flex-col gap-6 max-w-3xl mx-auto w-full min-w-0">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row justify-end gap-3">
                        <button type="button" onClick={() => window.history.length > 1 ? window.history.back() : router.visit('/p5')} className="w-full sm:w-auto px-6 py-2.5 text-sm font-medium text-muted-foreground hover:text-foreground transition text-center">Batal</button>
