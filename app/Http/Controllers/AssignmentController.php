    ...
    public function create()
    {
        ...
        return Inertia::render('assignments/create', [
            ...
            'instruments' => [
                ...
                'formative' => [
                    ['id' => 'formative_quiz',          'name' => 'Tes/Penugasan Singkat', 'icon' => 'clipboard-check', 'desc' => 'Ujian singkat atau kuis untuk memantau penguasaan materi (KKTP Interval)'],
                    ['id' => 'performance_observation', 'name' => 'Observasi',             'icon' => 'activity',        'desc' => 'Pengamatan keterlibatan & perilaku murid selama pembelajaran (KKTP Deskriptif)'],
                    ['id' => 'structured_assignment',   'name' => 'Kinerja / LKPD',        'icon' => 'file-text',       'desc' => 'Lembar kerja/tugas praktik menilai proses & produk (KKTP Deskriptif)'],
                    ['id' => 'oral_test',               'name' => 'Lisan',                 'icon' => 'mic',             'desc' => 'Tanya jawab lisan langsung untuk mengukur penalaran konsep (KKTP Interval)'],
                ],
                'summative' => [
    ...
    public function show(Request $request, LmsAssignment $assignment)
    {
        ...
        return Inertia::render('assignments/show', [
            ...
            'my_submission' => $mySubmission ? [
                ...
                'qualitative_score' => $mySubmission->qualitative_score,
                'kktp_details'      => $mySubmission->kktp_details,
